...
In the inductive step we want to show that $\forall k \in \Naturals, \; 3 \divides k^3 - k \; \implies \; 3 \divides (k+1)^3 - (k+1)$.
So, let $k$ be an arbitrary natural number such that  $3 \divides k^3 - k$.
...
By the inductive hypothesis (and the definition of divisibility), we know that there is an integer $q$ such that $k^3-k = 3q$.
